...
const BenefitCard: React.FC<BenefitCardProps> = ({ IconComponent, title, description }) => {
  return (
    <div className="group" tabIndex={0} role="article">
      <div className={`${styles.card} group-hover:shadow-xl group-hover:scale-105 group-focus:shadow-xl group-focus:scale-105 transition-all duration-300`}>
